...
describe('BenchmarkComparisonService', () => {
  ...
  describe('compareToBenchmark', () => {
    ...
    it('should calculate comparison for score above 75th percentile', async () => {
      ...
      expect(result!.performance_category).toBe('well_above'); // Score of 90 is above 90th percentile (95)
      expect(result!.percentile_rank).toBeGreaterThan(75);
      expect(result!.recommendations).toContain('Marktführerposition nutzen für weitere Expansion');
    });
  ...
  describe('calculateComparison (private method testing via public interface)', () => {
    ...
    it('should generate appropriate recommendations for each performance category', async () => {
      const testCases = [
        ...
        { score: 30, expectedCategory: 'well_below', expectedRecommendation: 'Sofortige Maßnahmen' }, // Below 25th percentile (50)
    ...
    it('should generate position descriptions correctly', async () => {
      const testCases = [
        ...
        { score: 30, expectedIndustry: 'Untere 25%', expectedRegion: 'Untere 25%' }, // Below 25th percentile
