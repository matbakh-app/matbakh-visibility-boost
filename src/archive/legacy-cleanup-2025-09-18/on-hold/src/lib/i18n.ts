...
i18n
  ...
  .init({
    ...
    ns: ['common', 'navigation', 'services', 'packages', 'hero', 'landing', 'trust', 'auth', 'adminPanel', 'onboarding', 'dashboard', 'cookieConsent', 'legal-kontakt', 'legal-contact', 'facebook-data-deletion', 'vc_result', 'vc_quick', 'vc_microcopy'],
    defaultNS: 'common'
  });
