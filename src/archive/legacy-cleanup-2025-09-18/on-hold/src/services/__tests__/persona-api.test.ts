...
describe('PersonaApiService', () => {
  ...
  describe('Error Handling', () => {
    it('should handle API errors gracefully', async () => {
      ...
      await expect(service.detectPersona(mockData)).rejects.toThrow('Persona detection failed: 500');
    ...
    it('should handle network errors', async () => {
      ...
      await expect(service.detectPersona(mockData)).rejects.toThrow('Network error');
    ...
    it('should validate input data', async () => {
      ...
      await expect(service.detectPersona(invalidData as any)).rejects.toThrow();
