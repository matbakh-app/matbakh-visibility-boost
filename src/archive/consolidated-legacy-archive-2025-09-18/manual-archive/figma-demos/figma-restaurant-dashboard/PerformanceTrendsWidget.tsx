...
const PerformanceTrendsWidget: React.FC = () => {
  ...
  return (
    <Card className="widget-card h-full flex flex-col" data-widget="performance-trends">
