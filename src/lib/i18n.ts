...
i18n
  ...
  .init({
    ...
    ns: ['common', 'navigation', 'services', 'packages', 'hero', 'landing', 'trust', 'auth', 'adminPanel', 'onboarding', 'dashboard', 'cookieConsent', 'legal-kontakt', 'legal-contact', 'facebook-data-deletion'],
    defaultNS: 'common'
  });
