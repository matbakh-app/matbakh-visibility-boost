export const deTranslations = {
  ...
  addons: {
    social_setup: {
      name: 'Social Media Kanal Setup',
      description: 'Professionelle Einrichtung Ihres Instagram oder Facebook Kanals',
      features: [
        'Profil-Optimierung',
    ...
    google_chatbot: {
      ...
      description: 'Automatisierte Antworten für Google Business Profile',
      features: [
    ...
    instagram_setup: {
      ...
      description: 'Professionelle Einrichtung Ihres Instagram Business Profils',
      features: [
    ...
    facebook_setup: {
      ...
      description: 'Vollständige Einrichtung Ihrer Facebook Business Seite',
      features: [
    ...
    social_chatbot: {
      ...
      description: 'Automatisierte Antworten für Social Media Kanäle',
      features: [
        'Automatische Kommentar-Antworten',
        'Direktnachrichten-Automation',
        'FAQ-Integration',
  ...
  services: {
    ...
    pageTitle: 'Unsere Services für Ihr Restaurant',
    pageSubtitle: 'Professionelle Digitallösungen, die Ihre Sichtbarkeit steigern und mehr Gäste in Ihr Restaurant bringen. Wir übernehmen die Technik - Sie konzentrieren sich auf Ihre Gäste.',
    coreTitle: 'Unsere Hauptservices',
    coreSubtitle: 'Drei essenzielle Services, die Ihr Restaurant digital erfolgreich machen',
    additionalTitle: 'Zusätzliche Services',
    ...
    setup: {
      ...
      coreTitle: 'Google Business Profil Setup',
      coreDescription: 'Professionelle Einrichtung und Optimierung Ihres Google Business Profils für maximale lokale Sichtbarkeit.',
    ...
    management: {
      ...
      coreDescription: 'Kontinuierliche Betreuung Ihrer Social Media Kanäle mit professionellen Inhalten und strategischem Engagement.',
    ...
    analytics: {
      ...
      coreTitle: 'KI-gestützte Chatbots',
      coreDescription: 'Intelligente Chatbots für automatisierte Kundeninteraktion und 24/7 Verfügbarkeit.',
  ...
  problem: {
    title: 'Kennen Sie diese Probleme?',
    subtitle: 'Als Gastronom haben Sie genug um die Ohren. Digitales Marketing sollte nicht auch noch Kopfzerbrechen bereiten.',
    invisible: {
  ...
  solution: {
    title: 'So lösen wir Ihre Probleme',
    subtitle: 'Sie müssen sich nicht um komplexe technische Anforderungen kümmern, wir erledigen das für Sie.',
    optimization: {
  ...
  legal: {
    ...
    datenschutz: {
      ...
      googleInfo: 'Wir verwenden Google OAuth für die Anmeldung. Dabei werden folgende Daten verarbeitet:',
      dataList: ['E-Mail-Adresse', 'Name', 'Google Business Profile Daten (mit Ihrer Einwilligung)'],
      dataUsage: 'Diese Daten werden ausschließlich zur Bereitstellung unserer Services verwendet.'
    },
    agb: {
