      ...
      <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <Card className="bg-white border-0 shadow-sm">
              <CardContent className="text-center p-6">
                ...
                <div className="text-3xl font-bold text-black mb-2">{t('trust.stats.rating.number')}</div>
                <div className="font-semibold text-gray-900 mb-2">{t('trust.stats.rating.label')}</div>
                <p className="text-sm text-gray-600">{t('trust.stats.rating.description')}</p>
              </CardContent>
            </Card>
          ...
          {[0, 1, 2].map((index) => (
            <Card key={index} className="bg-white border-0 shadow-sm">
              <CardContent className="p-6">
                ...
                <p className="text-gray-700 mb-4 italic">"{t(`trust.testimonials.items.${index}.text`)}"</p>
                <div className="border-t pt-4">
                  <div className="font-semibold text-black">{t(`trust.testimonials.items.${index}.author`)}</div>
                  <div className="text-sm text-gray-600">{t(`trust.testimonials.items.${index}.restaurant`)}</div>
                </div>
              </CardContent>
            </Card>
          ))}
        ...
        <div className="text-center mt-16">
          <div className="flex justify-center items-center gap-8 opacity-60">
            <div className="text-sm text-gray-500">{t('trust.certifications.text')}</div>
            <div className="text-sm font-semibold text-gray-700">{t('trust.certifications.google')}</div>
            <div className="text-sm font-semibold text-gray-700">{t('trust.certifications.facebook')}</div>
            <div className="text-sm text-gray-500">{t('trust.certifications.since')}</div>
          </div>
        </div>
      </div>
    </section>
