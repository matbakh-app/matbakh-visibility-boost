-- Migration: Hauptkategorien-Datenpflege - Leere Kategorien beheben (korrigiert)
-- Datum: 2025-01-29

-- 1. Cross-Tags für "Kunst, Unterhaltung & Freizeit"
INSERT INTO category_cross_tags (category_id, target_main_category, target_main_category_id, source, confidence_score)
SELECT 
  gc.id, 'entertainment-culture', 'eca79b94-6388-4659-bf20-012df3ad3c74'::uuid, 'manual', 0.9
...
INSERT INTO category_cross_tags (category_id, target_main_category, target_main_category_id, source, confidence_score)
SELECT 
  gc.id, 'home-garden', '76cb29ad-6614-40a1-ae4f-b59a61fceeff'::uuid, 'manual', 0.8
FROM gmb_categories gc
...
INSERT INTO category_cross_tags (category_id, target_main_category, target_main_category_id, source, confidence_score)
SELECT 
  gc.id, 'technology-electronics', '523ea6e7-0f71-45df-83f0-53e7aa0eb460'::uuid, 'manual', 0.7
FROM gmb_categories gc
...
INSERT INTO category_cross_tags (category_id, target_main_category, target_main_category_id, source, confidence_score)
SELECT
  gc.id, 'pets-animals', '50a58860-b570-4b35-bf69-9945e0c23b0c'::uuid, 'manual', 0.8
FROM gmb_categories gc
WHERE gc.main_category_id = '04661964-a411-4e9a-aa49-e162d5dc762a'::uuid
  AND (
